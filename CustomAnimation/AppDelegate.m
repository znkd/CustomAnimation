...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    CustomNavigationController* customNavigationVC = [[CustomNavigationController alloc]initWithRootViewController:vc];
    
    //_navDelegate = [[NavigationCustomAnimationDelegate alloc]init];
    
    //UINavigationController* customNavigationVC = [[UINavigationController alloc]initWithRootViewController:vc];
    //customNavigationVC.delegate = _navDelegate;
